...
source_files:
  ...
  - docs/audit/12a-modulo-inventandobj-detalle.md
  - docs/CONVENTIONS.md
...
Conforme a las directivas de porting institucional de [`docs/CONVENTIONS.md`](../CONVENTIONS.md), los hallazgos de la auditoría técnica ([`docs/audit/12a-modulo-inventandobj-detalle.md`](../audit/12a-modulo-inventandobj-detalle.md)) y los registros estratégicos del Master Bug Ledger ([`docs/implementation/KNOWN-LEGACY-BUGS.md`](KNOWN-LEGACY-BUGS.md)), este desglose define un plan de trabajo estructurado en **cuatro fases secuenciales e independientes**.
