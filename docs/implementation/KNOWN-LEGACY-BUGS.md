...
- **Documentación Detallada**: [`18-modulo-inventandobj.md`](18-modulo-inventandobj.md#2-replicación-del-bug-27-asimetría-de-givegld-en-npc_tirar_items) y [`docs/audit/12a-modulo-inventandobj-detalle.md`](../audit/12a-modulo-inventandobj-detalle.md#73-asimetría-y-desaparición-del-oro-de-npcs-givegld).
