...
- **Referencia**: [`docs/implementation/15-clsclan-modguilds.md`](docs/implementation/15-clsclan-modguilds.md#2-resolucion-de-empates-en-elecciones-contarvotos--mayorvalor).
...
- **Referencia**: [`docs/implementation/04-clsdicc.md`](docs/implementation/04-clsdicc.md#3-preservacion-del-orden-de-insercion-y-comportamiento-de-empates-en-mayorvalor).
...
- **Referencia**: [`docs/implementation/04-clsdicc.md`](docs/implementation/04-clsdicc.md#2-eliminacion-del-cap-de-100-elementos-desviacion-intencional-documentada) y [`docs/audit/01a-clsdicc-cgarbage.md`](docs/audit/01a-clsdicc-cgarbage.md).
...
- **Referencia**: [`docs/implementation/03-clsinireader.md`](docs/implementation/03-clsinireader.md#quirk-prominente-de-keyexists).
...
- **Referencia**: [`docs/implementation/06-modcola-queue-colaarray.md`](docs/implementation/06-modcola-queue-colaarray.md#respuestas-por-defecto-en-casos-de-error-o-cola-vacia).
...
- **Referencia**: [`docs/implementation/07-modhexastrings.md`](docs/implementation/07-modhexastrings.md#3-relleno-de-ceros-a-la-izquierda-zero-padding-para-longitud-impar).
...
- **Referencia**: [`docs/implementation/07-modhexastrings.md`](docs/implementation/07-modhexastrings.md#4-tolerancia-a-caracteres-no-hexadecimales-y-espacios-valh--hex).
...
- **Referencia**: [`docs/implementation/08-csolicitud.md`](docs/implementation/08-csolicitud.md#2-nombres-de-miembros-de-datos-segun-la-naming-policy) y [`docs/implementation/15-clsclan-modguilds.md`](docs/implementation/15-clsclan-modguilds.md#1-frontera-de-serializacion-de-csolicitud-mapeo-dto-vs-claves-ini).
...
- **Referencia**: [`docs/implementation/12-fileio-tablas-datos.md`](docs/implementation/12-fileio-tablas-datos.md#3-analisis-de-caso-de-borde-en-loadobjdata-claseprohibida).
...
- **Referencia**: [`docs/implementation/14-fileio-backup-logging.md`](docs/implementation/14-fileio-backup-logging.md#a-formatos-de-registro-y-quirk-historico-de-extensiones-log-vs-dat).
...
Consultá directamente el documento dedicado: [`docs/implementation/16a-securityip-known-bugs.md`](docs/implementation/16a-securityip-known-bugs.md).
